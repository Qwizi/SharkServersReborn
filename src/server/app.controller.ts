...
export class AppController {
  ...
  async activateAccountGet(@Query('code') encryptedCode, @Res() res) {
    if (encryptedCode) {
      try {
  ...
  async activateAccountEncryptedCodePost(@Body() activateAccountCodeDto) {
    return await this.appService.activateAccountEncryptedCode(
  ...
  async resendActivateAccountEmailPost(
    ...
    return this.appService.resendActivateAccountEmail(
      resentActivateAccountEmailDto,
      req,
    );
  }
  ...
  async resetPasswordGet(@Body() checkResetPassword: CheckResetPasswordDto) {
    return this.appService.checkCode(checkResetPassword);
  }

  @HttpCode(200)
  @Post('reset-password')
  async resetPasswordPost(@Body() resetPasswordPostDto: ResetPasswordPostDto) {
