...
export class PositionQuestionAnswerController
  implements CrudController<PositionQuestionAnswer>
{
  constructor(public service: PositionQuestionAnswerService) {}
  ...
  async createOne(
    ...
    @ParsedBody() dto: CreateApplicationDto,
  ) {
